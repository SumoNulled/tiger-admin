...
<body class="<?php print_r(App\Phrases::get('theme_color')); ?>">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <?php
              function add_cadets($_ARRAY = array(), $error = null, $success = null)
              {
                ...
                array(
                  ...
                  $form->add_input_text(12, "push_ups[]", "Push-Ups", NULL, NULL, TRUE, NULL),
                  $form->add_input_text(12, "curl_ups[]", "Curl-Ups", NULL, NULL, TRUE, NULL),
                  $form->add_input_text(12, "one_mile_run[]", "1MR", NULL, NULL, NULL, NULL)
                ),
                );
              ...
              foreach(App\SQL::row("SELECT * FROM personnel_ccfa_scores AS m JOIN personnel as p ON p.id = m.cadet_id WHERE m.assessment_id = {$_ARRAY['id']} ORDER BY p.last_name") as $row)
              {
                ...
                $table->add_table_row(
                  array(
                    ...
                    $user->print_name(1),
                    $form->add_input_text(12, "push_ups[]", "Push Ups", $row['push_ups'], NULL, TRUE, NULL),
                    $form->add_input_text(12, "curl_ups[]", "Curl Ups", $row['curl_ups'], NULL, TRUE, NULL),
                    $form->add_input_text(12, "one_mile_run[]", "One Mile Run (MM:SS)", $row['one_mile_run'], NULL, NULL, NULL),
            ...
            App\General::root_include('private/admin/pages/personnel/assessments/ccfa/includes/backend/edit.php');
            ?>
