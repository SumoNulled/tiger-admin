        ...
        <div class="container-fluid">
            ...
            <?php
              function add_cadets($_ARRAY = array(), $error = null, $success = null)
              {
                ...
                $form->add_row("Please select the cadet from the list below.", NULL,
                $form->add_select("id[]", Admin\User::get_users(), NULL, NULL, NULL, NULL),
                );
              ...
              foreach(App\SQL::row("SELECT * FROM personnel_ccfa_scores AS m JOIN personnel as p ON p.id = m.cadet_id WHERE m.assessment_id = {$_ARRAY['id']} ORDER BY p.last_name") as $row)
              {
                ...
                $table->add_table_row(
                  array(
                    ...
                    $form->add_input_text(12, "one_mile_run[]", "One Mile Run (MM:SS)", gmdate('i:s', $row['one_mile_run']), NULL, NULL, NULL),
