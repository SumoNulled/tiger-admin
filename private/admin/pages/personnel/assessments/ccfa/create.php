...
<body class="<?php print_r(App\Phrases::get('theme_color')); ?>">
    ...
    <section class="content">
        ...
        function renderForm($error = null, $success = null)
        {
          ...
          $form->add_select("type", array("CCFA%Cadet Command Fitness Assessment"), NULL, TRUE, NULL, "<small>Type of Assessment</small>"),
          $form->add_input_text(5, "description", "Description", NULL, NULL, NULL, NULL),
          );

          $form->add_row(NULL, NULL,
          $form->add_select("record", array("1%For Record", "0%Diagnostic"), NULL, TRUE, NULL, "<small>Is it for record?</small>"),
          $form->add_select("oic", Admin\User::get_users(), NULL, NULL, NULL, "<small>Officer In Charge</small>"),
          $form->add_select("ncoic", Admin\User::get_users(), NULL, NULL, NULL, "<small>NCO In Charge</small>"),
          $form->add_input_date(3, "date", "Date", date("m/d/o"), "<small>Ex. MM/DD/YYYY</small>")
          );
        ...
        App\General::root_include('private/admin/pages/personnel/assessments/ccfa/includes/backend/create.php');
        ?>
    </section>
