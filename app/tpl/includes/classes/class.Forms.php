...
class Forms
{
    ...
    public function add_input_file()
    {
      $result =
      "<div class=\"col-lg-12\">
    ...
    function add_select_multiple($name = null, array $value = array(), $current = NULL, $title = NULL, $required = NULL, $permission = NULL,)
    {
      ...
      "<div id=\"" . $name . "_div\" class=\"col-lg-12 col-md-12 col-sm-12\">
            <select size=\"" . sizeof($value) . "\" title=\"$title\" id=\"" . $name . "_select\" name=\"" . $name . "\" class=\"form-control show-tick\" data-live-search=\"true\" data-selected-text-format=\"count\" tabindex=\"-98\" multiple {$required}>
                <option value=\"\" {$status}>N/A</option>";
    ...
    function add_select_search($name = null, array $value = array(), $title = NULL, $required = NULL, $permission = NULL,)
    {
      $status = NULL;
      ...
      $result=
      "<div id=\"" . $name . "_div\" class=\"col-lg-12 col-md-12 col-sm-12\">
            <select title=\"$title\" id=\"" . $name . "_select\" name=\"" . $name . "\" class=\"form-control show-tick\" data-live-search=\"true\" data-selected-text-format=\"count\" tabindex=\"-98\" {$required}>
                <option value=\"\" {$status}>N/A</option>";
        ...
        for($i = 0; $i < sizeof($value); $i++)
        {
            ...
            $result .= html_entity_decode("\n &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<option {$status} value=\"" . $val . "\">" . $text . "</option>");
        }
    ...
    public function print()
    {
      ...
      $result = "";
      $result.= "\t" . "<form class=\"" . $this->get_class() . "\" id=\"" . $this->get_name() . "\" action=\"" . $this->get_action() ."\" method=\"" . $this->get_method() ."\" enctype=\"" . $this->get_enc() ."\">" . "\n";
